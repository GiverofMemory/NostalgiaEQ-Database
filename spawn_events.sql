...
INSERT INTO `spawn_events` (`id`, `zone`, `cond_id`, `name`, `period`, `next_minute`, `next_hour`, `next_day`, `next_month`, `next_year`, `enabled`, `action`, `argument`, `strict`) VALUES
	...
	(48, 'qeynos', 2, 'Enable Day', 1440, 1, 7, 8, 5, 3894, 1, 0, 1, 0),
	(49, 'qeynos', 2, 'Disable Day', 1440, 0, 21, 8, 5, 3894, 1, 0, 0, 0),
	(50, 'qeynos', 1, 'Enable Night', 1440, 1, 21, 8, 5, 3894, 1, 0, 1, 0),
	(51, 'qeynos', 1, 'Disable Night', 1440, 0, 7, 8, 5, 3894, 1, 0, 0, 0),
	(52, 'qeynos2', 2, 'Enable Day', 1440, 1, 7, 28, 4, 3894, 1, 0, 1, 0),
	(53, 'qeynos2', 2, 'Disable Day', 1440, 0, 21, 27, 4, 3894, 1, 0, 0, 0),
	(54, 'qeynos2', 1, 'Enable Night', 1440, 1, 21, 27, 4, 3894, 1, 0, 1, 0),
	(55, 'qeynos2', 1, 'Disable Night', 1440, 0, 7, 28, 4, 3894, 1, 0, 0, 0),
	...
	(92, 'qeynos', 3, 'EnableSea', 480, 1, 23, 7, 5, 3894, 1, 0, 1, 1),
	(93, 'qeynos', 3, 'DisableSea', 480, 0, 3, 8, 5, 3894, 1, 0, 0, 1),
	(94, 'qeynos', 4, 'EnableGolden', 480, 1, 3, 8, 5, 3894, 1, 0, 1, 1),
	(95, 'qeynos', 4, 'DisableGolden', 480, 0, 23, 7, 5, 3894, 1, 0, 0, 1),
	...
	(152, 'qcat', 1, 'CourierUp', 1440, 1, 7, 8, 5, 3894, 1, 0, 1, 0),
	(153, 'qcat', 1, 'CourierDown', 1440, 0, 20, 8, 5, 3894, 1, 0, 0, 0),
	(154, 'qcat', 2, 'MalkaUp', 1440, 1, 21, 8, 5, 3894, 1, 0, 1, 0),
	(155, 'qcat', 2, 'MalkaDown', 1440, 0, 6, 8, 5, 3894, 1, 0, 0, 0),

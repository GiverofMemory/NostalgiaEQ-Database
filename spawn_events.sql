...
INSERT INTO `spawn_events` (`id`, `zone`, `cond_id`, `name`, `period`, `next_minute`, `next_hour`, `next_day`, `next_month`, `next_year`, `enabled`, `action`, `argument`, `strict`) VALUES
	...
	(5, 'commons', 2, 'Enable Day', 1440, 1, 7, 2, 9, 3894, 1, 0, 1, 0),
	(6, 'commons', 2, 'Disable Day', 1440, 0, 21, 2, 9, 3894, 1, 0, 0, 0),
	(7, 'commons', 1, 'Enable Night', 1440, 1, 21, 2, 9, 3894, 1, 0, 1, 0),
	(8, 'commons', 1, 'Disable Night', 1440, 0, 7, 2, 9, 3894, 1, 0, 0, 0),
	...
	(17, 'lakerathe', 2, 'Enable Day', 1440, 1, 7, 20, 12, 3894, 1, 0, 1, 0),
	(18, 'lakerathe', 2, 'Disable Day', 1440, 0, 21, 19, 12, 3894, 1, 0, 0, 0),
	(19, 'lakerathe', 1, 'Enable Night', 1440, 1, 21, 19, 12, 3894, 1, 0, 1, 0),
	(20, 'lakerathe', 1, 'Disable Night', 1440, 0, 7, 20, 12, 3894, 1, 0, 0, 0),
	...
	(27, 'oggok', 2, 'Enable Ryn', 1440, 1, 9, 21, 12, 3894, 1, 0, 1, 0),
	(28, 'oggok', 2, 'Disable Ryn', 1440, 0, 13, 21, 12, 3894, 1, 0, 0, 0),
	(29, 'oggok', 1, 'Enable Gronk', 1440, 1, 13, 21, 12, 3894, 1, 0, 1, 0),
	(30, 'oggok', 1, 'Disable Gronk', 1440, 0, 9, 21, 12, 3894, 1, 0, 0, 0),
	...
	(48, 'qeynos', 2, 'Enable Day', 1440, 1, 7, 23, 12, 3894, 1, 0, 1, 0),
	(49, 'qeynos', 2, 'Disable Day', 1440, 0, 21, 22, 12, 3894, 1, 0, 0, 0),
	(50, 'qeynos', 1, 'Enable Night', 1440, 1, 21, 22, 12, 3894, 1, 0, 1, 0),
	(51, 'qeynos', 1, 'Disable Night', 1440, 0, 7, 23, 12, 3894, 1, 0, 0, 0),
	(52, 'qeynos2', 2, 'Enable Day', 1440, 1, 7, 21, 12, 3894, 1, 0, 1, 0),
	(53, 'qeynos2', 2, 'Disable Day', 1440, 0, 21, 20, 12, 3894, 1, 0, 0, 0),
	(54, 'qeynos2', 1, 'Enable Night', 1440, 1, 21, 20, 12, 3894, 1, 0, 1, 0),
	(55, 'qeynos2', 1, 'Disable Night', 1440, 0, 7, 21, 12, 3894, 1, 0, 0, 0),
	(56, 'qeytoqrg', 2, 'Enable Day', 1440, 1, 7, 15, 12, 3894, 1, 0, 1, 0),
	(57, 'qeytoqrg', 2, 'Disable Day', 1440, 0, 21, 14, 12, 3894, 1, 0, 0, 0),
	(58, 'qeytoqrg', 1, 'Enable Night', 1440, 1, 21, 14, 12, 3894, 1, 0, 1, 0),
	(59, 'qeytoqrg', 1, 'Disable Night', 1440, 0, 7, 15, 12, 3894, 1, 0, 0, 0),
	(60, 'freporte', 2, 'Enable Day', 1440, 1, 9, 22, 12, 3894, 1, 0, 1, 0),
	...
	(72, 'freporte', 3, 'EnableStorm', 480, 1, 11, 22, 12, 3894, 1, 0, 1, 1),
	(73, 'freporte', 3, 'DisableStorm', 480, 0, 15, 22, 12, 3894, 1, 0, 0, 1),
	(74, 'freporte', 4, 'EnableSirens', 480, 1, 15, 22, 12, 3894, 1, 0, 1, 1),
	(75, 'freporte', 4, 'DisableSirens', 480, 0, 11, 22, 12, 3894, 1, 0, 0, 1),
	...
	(92, 'qeynos', 3, 'EnableSea', 480, 1, 15, 22, 12, 3894, 1, 0, 1, 1),
	(93, 'qeynos', 3, 'DisableSea', 480, 0, 11, 22, 12, 3894, 1, 0, 0, 1),
	(94, 'qeynos', 4, 'EnableGolden', 480, 1, 11, 22, 12, 3894, 1, 0, 1, 1),
	(95, 'qeynos', 4, 'DisableGolden', 480, 0, 15, 22, 12, 3894, 1, 0, 0, 1),
	...
	(104, 'neriakb', 2, 'Enable Day', 1440, 1, 7, 7, 12, 3894, 1, 0, 1, 0),
	(105, 'neriakb', 2, 'Disable Day', 1440, 0, 21, 6, 12, 3894, 1, 0, 0, 0),
	(106, 'neriakb', 1, 'Enable Night', 1440, 1, 21, 6, 12, 3894, 1, 0, 1, 0),
	(107, 'neriakb', 1, 'Disable Night', 1440, 0, 7, 7, 12, 3894, 1, 0, 0, 0),
	...
	(120, 'neriakc', 1, 'TaniDown', 1440, 1, 19, 6, 12, 3894, 1, 0, 0, 0),
	(121, 'neriakc', 1, 'TaniUp', 1440, 0, 21, 6, 12, 3894, 1, 0, 1, 0),
	...
	(152, 'qcat', 1, 'CourierUp', 1440, 1, 7, 23, 12, 3894, 1, 0, 1, 0),
	(153, 'qcat', 1, 'CourierDown', 1440, 0, 20, 22, 12, 3894, 1, 0, 0, 0),
	(154, 'qcat', 2, 'MalkaUp', 1440, 1, 21, 22, 12, 3894, 1, 0, 1, 0),
	(155, 'qcat', 2, 'MalkaDown', 1440, 0, 6, 23, 12, 3894, 1, 0, 0, 0),

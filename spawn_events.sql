...
INSERT INTO `spawn_events` (`id`, `zone`, `cond_id`, `name`, `period`, `next_minute`, `next_hour`, `next_day`, `next_month`, `next_year`, `enabled`, `action`, `argument`, `strict`) VALUES
	...
	(5, 'commons', 2, 'Enable Day', 1440, 1, 7, 5, 2, 3895, 1, 0, 1, 0),
	(6, 'commons', 2, 'Disable Day', 1440, 0, 21, 4, 2, 3895, 1, 0, 0, 0),
	(7, 'commons', 1, 'Enable Night', 1440, 1, 21, 4, 2, 3895, 1, 0, 1, 0),
	(8, 'commons', 1, 'Disable Night', 1440, 0, 7, 5, 2, 3895, 1, 0, 0, 0),
	...
	(17, 'lakerathe', 2, 'Enable Day', 1440, 1, 7, 17, 3, 3895, 1, 0, 1, 0),
	(18, 'lakerathe', 2, 'Disable Day', 1440, 0, 21, 16, 3, 3895, 1, 0, 0, 0),
	(19, 'lakerathe', 1, 'Enable Night', 1440, 1, 21, 16, 3, 3895, 1, 0, 1, 0),
	(20, 'lakerathe', 1, 'Disable Night', 1440, 0, 7, 17, 3, 3895, 1, 0, 0, 0),
	(21, 'lfaydark', 1, 'Enable Night', 1440, 1, 21, 26, 9, 3892, 1, 0, 1, 0),
	(22, 'lfaydark', 1, 'Disable Night', 1440, 0, 7, 27, 9, 3892, 1, 0, 0, 0),
	(23, 'northkarana', 2, 'Enable Day', 1440, 1, 7, 28, 8, 3894, 1, 0, 1, 0),
	(24, 'northkarana', 2, 'Disable Day', 1440, 0, 21, 27, 8, 3894, 1, 0, 0, 0),
	(25, 'northkarana', 1, 'Enable Night', 1440, 1, 21, 27, 8, 3894, 1, 0, 1, 0),
	(26, 'northkarana', 1, 'Disable Night', 1440, 0, 7, 28, 8, 3894, 1, 0, 0, 0),
	(27, 'oggok', 2, 'Enable Ryn', 1440, 1, 9, 2, 1, 3895, 1, 0, 1, 0),
	(28, 'oggok', 2, 'Disable Ryn', 1440, 0, 13, 2, 1, 3895, 1, 0, 0, 0),
	(29, 'oggok', 1, 'Enable Gronk', 1440, 1, 13, 2, 1, 3895, 1, 0, 1, 0),
	(30, 'oggok', 1, 'Disable Gronk', 1440, 0, 9, 2, 1, 3895, 1, 0, 0, 0),
	(31, 'qey2hh1', 2, 'Enable Day', 1440, 1, 7, 28, 8, 3894, 1, 0, 1, 0),
	(32, 'qey2hh1', 2, 'Disable Day', 1440, 0, 20, 27, 8, 3894, 1, 0, 0, 0),
	(33, 'qey2hh1', 1, 'Enable Night', 1440, 1, 20, 27, 8, 3894, 1, 0, 1, 0),
	(34, 'qey2hh1', 1, 'Disable Night', 1440, 0, 7, 28, 8, 3894, 1, 0, 0, 0),
	...
	(43, 'southkarana', 2, 'Enable Day', 1440, 1, 7, 28, 8, 3894, 1, 0, 1, 0),
	(44, 'southkarana', 2, 'Disable Day', 1440, 0, 21, 27, 8, 3894, 1, 0, 0, 0),
	(45, 'southkarana', 1, 'Enable Night', 1440, 1, 21, 27, 8, 3894, 1, 0, 1, 0),
	(46, 'southkarana', 1, 'Disable Night', 1440, 0, 7, 28, 8, 3894, 1, 0, 0, 0),
	(47, 'guildlobby', 1, 'Time Keeper', 1440, 0, 6, 25, 5, 3892, 1, 0, 0, 0),
	(48, 'qeynos', 2, 'Enable Day', 1440, 1, 7, 14, 1, 3895, 1, 0, 1, 0),
	(49, 'qeynos', 2, 'Disable Day', 1440, 0, 21, 13, 1, 3895, 1, 0, 0, 0),
	(50, 'qeynos', 1, 'Enable Night', 1440, 1, 21, 13, 1, 3895, 1, 0, 1, 0),
	(51, 'qeynos', 1, 'Disable Night', 1440, 0, 7, 14, 1, 3895, 1, 0, 0, 0),
	(52, 'qeynos2', 2, 'Enable Day', 1440, 1, 7, 22, 1, 3895, 1, 0, 1, 0),
	(53, 'qeynos2', 2, 'Disable Day', 1440, 0, 21, 22, 1, 3895, 1, 0, 0, 0),
	(54, 'qeynos2', 1, 'Enable Night', 1440, 1, 21, 22, 1, 3895, 1, 0, 1, 0),
	(55, 'qeynos2', 1, 'Disable Night', 1440, 0, 7, 22, 1, 3895, 1, 0, 0, 0),
	(56, 'qeytoqrg', 2, 'Enable Day', 1440, 1, 7, 3, 1, 3895, 1, 0, 1, 0),
	(57, 'qeytoqrg', 2, 'Disable Day', 1440, 0, 21, 2, 1, 3895, 1, 0, 0, 0),
	(58, 'qeytoqrg', 1, 'Enable Night', 1440, 1, 21, 2, 1, 3895, 1, 0, 1, 0),
	(59, 'qeytoqrg', 1, 'Disable Night', 1440, 0, 7, 3, 1, 3895, 1, 0, 0, 0),
	(60, 'freporte', 2, 'Enable Day', 1440, 1, 9, 23, 12, 3894, 1, 0, 1, 0),
	(61, 'freporte', 2, 'Disable Day', 1440, 0, 23, 22, 12, 3894, 1, 0, 0, 0),
	(62, 'freporte', 1, 'Enable Night', 1440, 1, 23, 22, 12, 3894, 1, 0, 1, 0),
	(63, 'freporte', 1, 'Disable Night', 1440, 0, 9, 23, 12, 3894, 1, 0, 0, 0),
	...
	(72, 'freporte', 3, 'EnableStorm', 480, 1, 19, 22, 12, 3894, 1, 0, 1, 1),
	(73, 'freporte', 3, 'DisableStorm', 480, 0, 15, 22, 12, 3894, 1, 0, 0, 1),
	(74, 'freporte', 4, 'EnableSirens', 480, 1, 15, 22, 12, 3894, 1, 0, 1, 1),
	(75, 'freporte', 4, 'DisableSirens', 480, 0, 19, 22, 12, 3894, 1, 0, 0, 1),
	(76, 'butcher', 1, 'EnableStorm', 480, 1, 15, 28, 4, 3894, 1, 0, 1, 1),
	(77, 'butcher', 1, 'DisableStorm', 480, 0, 19, 28, 4, 3894, 1, 0, 0, 1),
	(78, 'butcher', 2, 'EnableSirens', 480, 1, 19, 28, 4, 3894, 1, 0, 1, 1),
	(79, 'butcher', 2, 'DisableSirens', 480, 0, 15, 28, 4, 3894, 1, 0, 0, 1),
	...
	(84, 'erudnext', 1, 'EnableSea', 480, 1, 19, 22, 2, 3893, 1, 0, 1, 1),
	(85, 'erudnext', 1, 'DisableSea', 480, 0, 15, 22, 2, 3893, 1, 0, 0, 1),
	(86, 'erudnext', 2, 'EnableGolden', 480, 1, 15, 22, 2, 3893, 1, 0, 1, 1),
	(87, 'erudnext', 2, 'DisableGolden', 480, 0, 19, 22, 2, 3893, 1, 0, 0, 1),
	...
	(92, 'qeynos', 3, 'EnableSea', 480, 1, 23, 13, 1, 3895, 1, 0, 1, 1),
	(93, 'qeynos', 3, 'DisableSea', 480, 0, 19, 13, 1, 3895, 1, 0, 0, 1),
	(94, 'qeynos', 4, 'EnableGolden', 480, 1, 19, 13, 1, 3895, 1, 0, 1, 1),
	(95, 'qeynos', 4, 'DisableGolden', 480, 0, 23, 13, 1, 3895, 1, 0, 0, 1),
	...
	(104, 'neriakb', 2, 'Enable Day', 1440, 1, 7, 20, 10, 3895, 1, 0, 1, 0),
	(105, 'neriakb', 2, 'Disable Day', 1440, 0, 21, 20, 10, 3895, 1, 0, 0, 0),
	(106, 'neriakb', 1, 'Enable Night', 1440, 1, 21, 20, 10, 3895, 1, 0, 1, 0),
	(107, 'neriakb', 1, 'Disable Night', 1440, 0, 7, 20, 10, 3895, 1, 0, 0, 0),
	...
	(120, 'neriakc', 1, 'TaniDown', 1440, 1, 19, 20, 10, 3895, 1, 0, 0, 0),
	(121, 'neriakc', 1, 'TaniUp', 1440, 0, 21, 20, 10, 3895, 1, 0, 1, 0),
	...
	(144, 'oasis', 1, 'EnableBarrel', 360, 1, 12, 1, 8, 3894, 1, 0, 1, 1),
	(145, 'oasis', 1, 'DisableBarrel', 360, 30, 9, 1, 8, 3894, 1, 0, 0, 1),
	(146, 'oasis', 2, 'EnableMuck', 360, 1, 9, 1, 8, 3894, 1, 0, 1, 1),
	(147, 'oasis', 2, 'DisableMuck', 360, 30, 12, 1, 8, 3894, 1, 0, 0, 1),
	...
	(152, 'qcat', 1, 'CourierUp', 1440, 1, 7, 24, 12, 3894, 1, 0, 1, 0),
	(153, 'qcat', 1, 'CourierDown', 1440, 0, 20, 24, 12, 3894, 1, 0, 0, 0),
	(154, 'qcat', 2, 'MalkaUp', 1440, 1, 21, 24, 12, 3894, 1, 0, 1, 0),
	(155, 'qcat', 2, 'MalkaDown', 1440, 0, 6, 24, 12, 3894, 1, 0, 0, 0),
